# Hello, I'm Saimanas Gourabathini 👋
...
- [House Price Prediction - MLOps Pipeline](https://github.com/saimanas17/housing-price-prediction-mlops) - Architected and deployed a production-grade MLOps system for house price prediction, implementing automated end-to-end workflows from data ingestion to model serving. Built comprehensive pipeline using Airflow for orchestration, MLflow for experiment tracking and model registry, and BentoML for serving predictions via RESTful API. Established GitOps-driven CI/CD using Jenkins and ArgoCD, deployed on Kubernetes with automated weekly retraining, achieving seamless model versioning and zero-downtime deployments.
- [Argo Rollouts - Blue-Green Deployment Strategy](https://github.com/saimanas17/argocd-bluegreen) - Implemented automated Blue-Green deployment strategy using Argo Rollouts on Kubernetes to enable zero-downtime releases with instant rollback capability. Developed CI/CD pipeline with Jenkins that builds Docker images, updates Kubernetes manifests, and triggers GitOps-based deployments through ArgoCD. Created preview and production environments allowing thorough testing before traffic switching, with manual approval gates for controlled production releases. Demonstrated advanced Kubernetes deployment patterns for high-availability applications.
